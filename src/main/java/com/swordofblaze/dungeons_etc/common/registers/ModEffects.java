...
import com.swordofblaze.dungeons_etc.common.effects.BlightEffect;
import com.swordofblaze.dungeons_etc.common.effects.MarkEffect;
...
public class ModEffects {
    ...
    public static final RegistryObject<Effect> DEATH_MARK = EFFECTS.register("death_mark", () -> new MarkEffect(EffectType.HARMFUL, 0xC30200));
    ...
    public static final RegistryObject<Effect> BLIGHT = EFFECTS.register("blight", () -> new BlightEffect(EffectType.HARMFUL, 0x6A780E));
