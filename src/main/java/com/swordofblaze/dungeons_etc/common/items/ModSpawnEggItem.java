...
public class ModSpawnEggItem extends Item {
    ...
    private static final Map<Supplier<? extends EntityType<?>>, ModSpawnEggItem> EGGS = new HashMap<>();
    private final int primaryColor, secondaryColor;
    Supplier<? extends EntityType<?>> entityTypeSupplier;

    public ModSpawnEggItem(Supplier<? extends EntityType<?>> entityType, int primaryColor, int secondaryColor) {
